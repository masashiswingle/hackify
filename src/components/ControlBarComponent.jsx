  ...
  render() {
    return(
      <div id="controlDiv">
        ...
        <div onClick={ this.mute.bind(this) }>
        ...
        <div id="volumeDiv" onChange={ this.volume.bind(this) }>
          <label htmlFor="volume">Volume</label>
          <input type="range" id="volume" title="Volume" min="0" max="100" step="1"></input>
        </div>
      </div>
    );
  }
